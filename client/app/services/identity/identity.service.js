  ...
  .service('Identity', function Identity($log, Storage, Communication) {
    ...
    this.contacts = {
      '20caf602a4f4b9dcb3133062af672d9ac877244c16439cbce93c40629bcfd5e8': {
        ...
        name: 'contact1', isOpen: true, isActive: true, hasUnread: true, openChat: open, closeChat: close, message: ''
      },
      '904bq87gbq348fbqa3097849432': {
        id: '904bq87gbq348fbqa3097849432',
        name: 'contact2', isOpen: false, isActive: false, hasUnread: false, openChat: open, closeChat: close, message: '',
        messages: [{content: '1', author: 'contact2'},{content: '2', author: 'contact2'},{content: '3', author: 'contact2'},{content: '4', author: 'contact2'}]
      },
      '978432qgb8q37gb4587g43qb987': {
        id: '978432qgb8q37gb4587g43qb987',
        name: 'contact3', isOpen: true, isActive: false, hasUnread: false, openChat: open, closeChat: close, message: ''
      }
    };
